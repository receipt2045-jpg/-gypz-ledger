...
const ROAST: Record<ReduceSub, string[]> = {
  ...
  delivery: [
    ...
    '배달비 {금액}에 별점까지 줬어? 통장은 별 하나도 안 줬는데 ⭐💀',
    '"오늘만"이 이번 달 {n}번째 "오늘만"이야 😮‍💨',
  ],
  cafe: [
    '또 카페? 스벅 별은 쌓이는데 잔고는 안 쌓여 ☕💀',
    '카페 사장님은 네 이름 외웠겠다. 통장은 널 잊었고 😭',
    '커피 한 잔의 여유… 통장엔 한 잔의 위기 ☕😮‍💨',
    '{금액}? 집에서 타 먹으면 그 돈 통장이 마셔 🫠',
  ],
  taxi: [
  ...
  food: [
    ...
    '집밥은 셀프 적금이야. 오늘은 왜 해지했어? 🍚',
    '{금액}? 장 봤으면 냉장고가 웃었을 텐데 😮‍💨',
    '주방은 개업 준비만 몇 년째야. 오늘도 사 먹었네 👩‍🍳💀',
  ],
  beauty: [
